            ...
            Scaffold(modifier = Modifier, containerColor = Color.Transparent,
                ...
                Column(
                    ...
                    Column(
                        ...
                        Text(text = "NOMOR ANDA SAAT INI", fontWeight = FontWeight.ExtraBold)
                        TextField(
...
//                val filteredText = newText.filter { it.isLetterOrDigit() }.take(12)
                        ...
                        Text(text = "MASUKKAN NO HP ANDA", fontWeight = FontWeight.ExtraBold)
                        TextField(
                            colors = TextFieldDefaults.colors(
                                unfocusedContainerColor = Color.White,
                                focusedContainerColor = Color.White
...
//                val filteredText = newText.filter { it.isLetterOrDigit() }.take(12)
                    ...
                    Button(
                        ...
                        onClick = {
                            profileNavController.navigate("${FeatureRouteScreens.KodeOTP.route}/${ProfileRouteScreens.UbahNoHP.route}")
                        }) {
                        Text(
